...
namespace Gui
{
    MainWindow::MainWindow(QWidget* parent):
        QMainWindow{parent},
        tilesGrid(GridImpl<Scalar>(PixelRect(-16, -8, 32, 16, 1.0), 1.0)),
        dotsGrid(GridImpl<Scalar>(PixelRect(-16, -8, 32, 16, 1.0), 1.0)),
        arrowGrid(GridImpl<Vector>(PixelRect(-16, -8, 32, 16, 1.0), 1.0))
    {
